...
const TEMPLATES: Template[] = [
  {
    id: 'bk01',
    chooseLabel: '人生四格-4連拍',
    preview: chooseLayoutBk01,
    shotCount: 4,
    sizeKey: '4x6_2IN',
    captureW: 460, /* 框圖寬度 */
    captureH: 340, /* 框圖高度 */
    stageSize: { maxWidth: '460px', maxHeight: 'calc(100vh - 200px)' },
    frameAspectRatio: '460/340',
    width: 1205,  /* 最後合成圖寬度 */
    height: 1795, /* 最後合成圖高度 */
    /** 只拍兩張：對應原四格版型的「上排」左、右兩格 */
    slots: [
      { x: 88, y: 173, w: 460, h: 340 },
      { x: 88, y: 543, w: 460, h: 340 },
      { x: 88, y: 913, w: 460, h: 340 },
      { x: 88, y: 1285, w: 460, h: 340 },
      { x: 666, y: 173, w: 460, h: 340 },
      { x: 666, y: 543, w: 460, h: 340 },
      { x: 666, y: 913, w: 460, h: 340 },
      { x: 666, y: 1285, w: 460, h: 340 },
    ],
    // 換新框圖時設 displayW / displayH 為新圖的實際寬高（px），預覽與 video 會用這個尺寸
    shootLayout: { layoutKey: 'bk01', captureW: 460, captureH: 340, displayW: 460, displayH: 340, previewScale: 1.42 },
  },
  {
    id: 'bk02',
    chooseLabel: '團體款式-1拍',
    ...
    captureW: 1600, /* 框圖寬度 */
    captureH: 900, /* 框圖高度 */
    stageSize: { maxWidth: '1600px', maxHeight: 'calc(100vh - 200px)' },
    frameAspectRatio: '1600/900',
    width: 1795,  /* 最後合成圖寬度 */
    height: 1205, /* 最後合成圖高度 */
    slots: [
  ...
  {
    id: 'bk03',
    chooseLabel: '窗戶款式-4連拍',
    preview: chooseLayoutBk03,
    shotCount: 4,
    sizeKey: '4x6',
    captureW: 500,
    captureH: 670,
    stageSize: { maxWidth: '500px', maxHeight: 'calc(100vh - 200px)' },
    frameAspectRatio: '500/670',
    width: 1205,
    height: 1795,
    slots: [
